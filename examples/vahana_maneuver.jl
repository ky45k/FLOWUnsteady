...
"""
function generate_maneuver_vahana(; disp_plot=true,    # If true, it will display a plot of the maneuver
    ...
    angle = (angle_main,)  # tandem 제거
    if add_rotors
        RPM = (RPM_main,)  # stacked, tandem 제거
    else
        RPM = ()
    end
