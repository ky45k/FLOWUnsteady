...
function generate_vahana_vehicle(;
                                    ...
                                    add_wings   = false,             # Whether to add the wings
    ...
    tiltrotor_file  = "kuam.csv"      # Tilt-rotor file
    R_w             = 1.3                  # (m) main-wing rotor radius (reference)
    R_tw            = R_w                   # (m) tandem-wing rotor radius (reference)
    CW_w            = false                  # Clockwise rotation of main-wing rotor
    CW_tw           = true                 # Clockwise rotation of tandem-wing rotor
    nr_w            = 1                     # Number of rotors per side of main wing
    nr_tw           = 1                     # Number of rotors per side of tandem wing
    pitch           = 0.0                   # (deg) collective pitch for tiltrotors rotors on main and tandem wings
    main_outtilt    = 0.0                    # (deg) Mount main-wing rotors with this out-tilt angle
    tandem_pitchtilt= 0.0                    # (deg) Mount tandem-wing rotors with this alternating pitch-tilt angle
    ...
    tilt_read_polar = vlm.ap.read_polar2     # What polar reader to use

    # Stacked rotors
    stackedrotor_file = "kuam.csv" # Stacked-rotor file
