...
run_name        = "SBS_10"      # Name of this simulation
...
# Rotor geometry
rotor_file      = "SBS_10.csv"             # Rotor geometry
data_path       = uns.def_data_path         # Path to rotor database
pitch           = 10.0                       # (deg) collective pitch of blades
...
Vinf(X, t)      = magVinf*[0, 0, 1]  # (m/s) freestream velocity vector
...
hubtiploss_correction = ((0.8, 4.0, 0.4, 8), (1.2, 1.0, 0.2, 0.05)) # Hub and tip correction

# VPM solver
vpm_integration = vpm.rungekutta3                 # VPM temporal integration scheme
# vpm_integration = vpm.rungekutta3

vpm_viscous     = vpm.CoreSpreading(-1, -1, vpm.zeta_fmm; beta=100.0, itmax=20, tol=1e-1)            # VPM viscous diffusion scheme
