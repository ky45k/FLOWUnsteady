...
run_name        = "cona_test"      # Name of this simulation
save_path       = run_name
...
# Rotor geometry
rotor_file      = "V.csv"             # Rotor geometry
...
Vinf(X, t)      = magVinf*[1, 0, 0]  # (m/s) freestream velocity vector
...
# Time parameters
nrevs           = 1334                        # Number of revolutions in simulation
nsteps_per_rev  = 36                        # Time steps per revolution
