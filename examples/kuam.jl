...
run_name        = "kuam_side_by_side_wake_treatment"      # Name of this simulation
...
# Rotor geometry
rotor_file      = "kuam.csv"             # Rotor geometry
...
RPM1            = 1455                      #Upper rotor
RPM2            = 1455                      #Lower rotor
...
Vinf(X, t)      = magVinf*[sind(AOA), 0, -cosd(AOA)]  # (m/s) freestream velocity vector
...
max_particles   = ((2*n+1)*B)*nsteps*p_per_step + 500000 # Maximum number of particles
...
# rmv_strngth = 2*2/p_per_step * dt/(30/(1455))         # Reference strength
# minmaxGamma = rmv_strngth*[0.00001, 0.05]                # Strength bounds (removes particles outside of these bounds)
...
wake_treatment_cyl1 = uns.remove_particles_cylinder(Pstart1, Pend1, Rcyl1, step)

Pstart2 = [0.0, 4.4, 0.0]
Pend2   = [-5R, 4.4, 0.0]
Rcyl2   = 2.2R

wake_treatment_cyl2 = uns.remove_particles_cylinder(Pstart2, Pend2, Rcyl2, step)

# Concatenate all wake treatments
wake_treatment = wake_treatment_cyl1#, wake_treatment_strength, wake_treatment_sigma)#uns.concatenate(wake_treatment_cyl, wake_treatment_strength, wake_treatment_sigma)
