...
run_name        = "kuam_mid_high"      # Name of this simulation
...
# Discretization
n               = 0                        # Number of blade elements per blade
...
sigmafactor_vpmonvlm= 3.5                     # Shrink particles by this factor when
                                            #  calculating VPM-on-VLM/Rotor induced velocities

# Rotor solver
vlm_rlx         = 0.5                       # VLM relaxation <-- this also applied to rotors
hubtiploss_correction = ((0.6, 5, 0.1, 0.05), (2, 1, 0.25, 0.05)) # Hub and tip correction
...
no_shedding_Rthreshold = suppress_fountain ? 0.3 : 0.0
...
wake_treatment = wake_treatment_cyl#, wake_treatment_strength, wake_treatment_sigma)
